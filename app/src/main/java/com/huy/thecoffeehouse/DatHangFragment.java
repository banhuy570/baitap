...
public class DatHangFragment extends Fragment {
    ...
    private void setUpViewPager(ViewPager mviewPager) {
        com.huy.thecoffeehouse.ViewPageAdapterFragmentDonHang viewPageAdapterFragmentDonHang = new com.huy.thecoffeehouse.ViewPageAdapterFragmentDonHang(getChildFragmentManager(),
