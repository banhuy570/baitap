...
public class Rcv_Adapter extends RecyclerView.Adapter<Rcv_Adapter.VerticalViewHolder> {
    private List<com.huy.thecoffeehouse.Rcv_Item> mListUser;

    public void setData(List<com.huy.thecoffeehouse.Rcv_Item> list) {
        this.mListUser = list;
    ...
    public void onBindViewHolder(@NonNull VerticalViewHolder holder, int position) {
        com.huy.thecoffeehouse.Rcv_Item hori2 = mListUser.get(position);
        if (hori2 == null) {
            return;
        }
